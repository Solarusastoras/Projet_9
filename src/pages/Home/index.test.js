...
it("a list of events is displayed", async () => {
  ...
  // Utilise le deuxième élément trouvé avec le texte "Nos réalisations"
  const realEvents = (await screen.findAllByText("Nos réalisations"))[1]; // Ajustez l'index si nécessaire
  expect(realEvents).toBeInTheDocument();
